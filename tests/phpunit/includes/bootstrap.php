 ...
 */
function _tests_load_classes(){
	define('JM_TC_DIRECTORY_PATH', trailingslashit(dirname(dirname(dirname(dirname(__FILE__))))));
	require JM_TC_DIRECTORY_PATH. 'jm-twitter-cards.php';
}

tests_add_filter('muplugins_loaded', '_tests_load_classes');
